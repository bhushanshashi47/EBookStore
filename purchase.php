...
?>
	...
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
              	<input type="text" maxlength="16" placeholder="1111-2222-3333-4444" class="form-control" name="card_number">
            </div>
        </div>
        <div class="form-group">
            <label for="card_PID" class="col-lg-2 control-label">CVV</label>
            <div class="col-lg-10">
              	<input type="text" placeholder="352" maxlength="3"class="form-control" name="card_PID">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
              	<input type="text" class="form-control"placeholder="Rahul Pratap Singh" name="card_owner">
            </div>
        </div>
        <div class="form-group">
